...
- Field extraction improvements (NER models)
- Additional document types (spreadsheets, HTML tables)
- Metadata persistence (PostgreSQL integration)
...
**Email**: malhotraishaan857@gmail.com  
**LinkedIn**: [linkedin.com/in/ishaan-malhotraai/](https://linkedin.com/in/ishaan-malhotraai/)  
**GitHub**: [github.com/Malhotra-Ishaan](https://github.com/Malhotra-Ishaan)

---

### Citation

If you use this evaluation methodology in your research, cite:

```bibtex
@software{malhotra2024multidoc,
  author = {Malhotra, Ishaan},
  title = {Multi-Document Structured Extraction with Adversarial Evaluation},
  year = {2024},
  url = {https://github.com/Malhotra-Ishaan/Multi-Document-Structured-Extraction}
}
```
